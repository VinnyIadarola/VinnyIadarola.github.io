...
const projects = [
    ...
    {
        id: 6,
        name: "Ebay Database Model",
        icon: "<img src='Images/Projects/Ebay.png' alt='JavaScript Project'>",
        tags: ["Entity-Relation Model", "Database", "SQLite", "School Project"],
        description: `
            Hidden Repo until grades are posted
        `,
        github: "https://github.com/VinnyIadarola/Ebay-Modeling-and-Schema"
    },
    {
        id: 7,
        name: "My Website",
